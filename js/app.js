...
function sproutedRecipe() {
	...
	`Combine ` + riceCups + ` cups of rice with ` + String(sproutedWaterCups) +
    ...
    `Remove from heat and let stand for 5 minutes. Fluff with a fork and serve.<br><br>` +
    `For softer rice: ` +
...
function whiteRecipe() {
    ...
    whiteRice.innerHTML =
    `Combine ` +  riceCups + ` cups of rice with ` + String(whiteWaterCups) +
